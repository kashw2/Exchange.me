    ...
    <body>
        ...
        <div id="grid-container">
            ...
            &&  isset($_SESSION['user']['username'])
                ...
                // Query
                $QUERY_CHECK_USER_EXISTS = mysqli_query($conn, '
                
                SELECT
                exchangeme.accounts.username
                FROM exchangeme.accounts
                WHERE exchangeme.accounts.username = "' . $_GET['Profile'] . '";
                
                ');

                // Fetch Result
                $RESULT_CHECK_USER_EXISTS = mysqli_fetch_array($QUERY_CHECK_USER_EXISTS);

                if(mysqli_num_rows($QUERY_CHECK_USER_EXISTS) > 0) {
                    ...
                    echo "
                            ...
                            <div id='profile-information'>
                                ...
                                <h3 id='information-biography-heading'>A few words from " . $RESULT_SELECT_PROFILE_INFO['username'] .  "...</h3>

                                <p id='information-biography'>" . $RESULT_SELECT_PROFILE_INFO['biography'] . "</p>
