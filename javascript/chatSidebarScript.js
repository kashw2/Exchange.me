	...
	function() {
		...
		var Sidebar_Init_Base_Layout = function(title, gridTemplateColumns, gridTemplateRows, lastColumn, execTime) {
			...
			setTimeout(function() {
				...
				// Add the event listner
				HTMLDivElement_Slider_Close.addEventListener(
					'click',
					function() {
						// Close the slider
						document.getElementById('chat-sidebar-slider').style.width = '0px';
				...
				switch (title) {
					case 'Account':
						...
						// Add the event listner
						HTMLParagraphElement_Account_Intro_Name.addEventListener(
							'mouseover',
							function() {
						...
						// Add the event listner
						HTMLInputElement_Account_Email.addEventListener(
							'click',
							function() {
								// Style the element
						...
						// Add the event listner
						HTMLInputElement_Account_Username.addEventListener(
							'click',
							function() {
								// Style the element
						...
						// Add the event listner
						HTMLInputElement_Account_Password.addEventListener(
							'click',
							function() {
								// Style the element
						...
						// Add the event listner
						HTMLInputElement_Account_Alias.addEventListener(
							'click',
							function() {
								// Style the element
						...
						// Add the event listner
						HTMLButtonElement_Account_Save.addEventListener(
							'mouseover',
							function() {
								// Style the button
						...
						// Add the event listner
						HTMLHeadingElement_Account_DangerZone.addEventListener(
							'mouseover',
							function() {
						...
						// Add the event listner
						HTMLButtonElement_Account_DeleteAccount.addEventListener(
							'mouseover',
							function() {
					...
					case 'Users':
						...
						// Add event listner
						HTMLButtonElement_Users_Option_Refresh.addEventListener(
							'focusout',
							function() {
								// Style the button
						...
						// Add the event listner
						HTMLParagraphElement_Users_Online_Type_Online.addEventListener(
							'mouseover',
							function() {
								// Style th element
						...
						// Add the event listner
						HTMLParagraphElement_Users_Online_Type_Friends.addEventListener(
							'mouseover',
							function() {
								// Style th element
		...
		// Add the event listner
		document.getElementById('sidebar-account').addEventListener(
			'click',
			function() {
		...
		// Add the event listner
		document.getElementById('sidebar-users').addEventListener(
			'click',
			function() {
				// Change the elements styling
